...
module.exports = "\n\n<div class=\"container\">\n  <div>\n    <input [(ngModel)]=\"article\" class=\"form-control\" placeholder=\"Search\">\n  </div>\n  <ul class=\"list-group\">\n    <li *ngFor=\"let article of articlesFound | filter:'name':article\" class=\"list-group-item clearfix\">\n      <img class=\"img-responsive img-rounded alargada\" [src]=\"'http://localhost:3000' + article.image\" height=100 alt=\"\"/>\n      <h3 class=\"list-group-item-heading\">\n        {{ article.name }}\n      </h3>\n      <p class=\"list-group-item-text lead\">\n        {{ article.description }}\n        <!-- <br />\n        <a [routerLink]=\"['/article-details', article._id]\"><small>Details&#8230;</small></a> -->\n      </p>\n      <div class=\"btn-toolbar pull-right\" role=\"toolbar\" aria-label=\"\">\n        <!-- <div class=\"btn-group\">\n          <button type=\"button\" class=\"btn btn-default dropdown-toggle\" data-toggle=\"dropdown\" aria-haspopup=\"true\" aria-expanded=\"false\"><i class=\"fa fa-fw fa-list\"></i> <span class=\"caret\"></span></button>\n          <ul class=\"dropdown-menu\">\n            <li><a href=\"#\">Add to new list</a></li>\n            <li role=\"separator\" class=\"divider\"></li>\n            <li><a href=\"#\">A list</a></li>\n            <li><a href=\"#\">Another list</a></li>\n            <li><a href=\"#\">Third list</a></li>\n          </ul>\n        </div> -->\n        <a [routerLink]=\"['/article-details', article._id]\" class=\"btn btn-primary\">Details</a>\n      </div>\n    </li>\n"
